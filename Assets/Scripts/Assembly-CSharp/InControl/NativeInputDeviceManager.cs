...
namespace InControl
{
	...
	{
		[CompilerGenerated]
		private sealed class _003CDetectDevice_003Ec__AnonStorey0
		{
			internal NativeDeviceInfo deviceInfo;

			internal bool _003C_003Em__0(NativeInputDeviceProfile profile)
			{
				return profile.Matches(deviceInfo);
			}

			internal bool _003C_003Em__1(NativeInputDeviceProfile profile)
			{
				return profile.Matches(deviceInfo);
			}

			internal bool _003C_003Em__2(NativeInputDeviceProfile profile)
			{
				return profile.LastResortMatches(deviceInfo);
			}

			internal bool _003C_003Em__3(NativeInputDeviceProfile profile)
			{
				return profile.LastResortMatches(deviceInfo);
			}
		}
		...
		{
			_003CDetectDevice_003Ec__AnonStorey0 _003CDetectDevice_003Ec__AnonStorey = new _003CDetectDevice_003Ec__AnonStorey0();
			_003CDetectDevice_003Ec__AnonStorey.deviceInfo = deviceInfo;
			NativeInputDeviceProfile nativeInputDeviceProfile = null;
			nativeInputDeviceProfile = nativeInputDeviceProfile ?? customDeviceProfiles.Find(_003CDetectDevice_003Ec__AnonStorey._003C_003Em__0);
			nativeInputDeviceProfile = nativeInputDeviceProfile ?? systemDeviceProfiles.Find(_003CDetectDevice_003Ec__AnonStorey._003C_003Em__1);
			nativeInputDeviceProfile = nativeInputDeviceProfile ?? customDeviceProfiles.Find(_003CDetectDevice_003Ec__AnonStorey._003C_003Em__2);
			nativeInputDeviceProfile = nativeInputDeviceProfile ?? systemDeviceProfiles.Find(_003CDetectDevice_003Ec__AnonStorey._003C_003Em__3);
			NativeInputDevice nativeInputDevice = FindDetachedDevice(_003CDetectDevice_003Ec__AnonStorey.deviceInfo) ?? new NativeInputDevice();
			nativeInputDevice.Initialize(deviceHandle, _003CDetectDevice_003Ec__AnonStorey.deviceInfo, nativeInputDeviceProfile);
