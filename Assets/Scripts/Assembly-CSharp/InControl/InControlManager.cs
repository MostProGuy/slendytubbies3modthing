		...
		private void OnEnable()
		{
			...
			if (InputManager.SetupInternal())
			{
				if (logDebugInfo)
				{
					...
					{
						_003C_003Ef__mg_0024cache0 = LogMessage;
					}
					Logger.OnLogMessage -= _003C_003Ef__mg_0024cache0;
					if (_003C_003Ef__mg_0024cache1 == null)
					{
						_003C_003Ef__mg_0024cache1 = LogMessage;
					}
					Logger.OnLogMessage += _003C_003Ef__mg_0024cache1;
				}
