...
namespace InControl
{
	public class InputManager
	{
		...
		[CompilerGenerated]
		private static Comparison<InputDevice> _003C_003Ef__am_0024cache0;
		...
		public static void AttachDevice(InputDevice inputDevice)
		{
			...
			if (!devices.Contains(inputDevice))
			{
				...
				{
					_003C_003Ef__am_0024cache0 = _003CAttachDevice_003Em__0;
				}
		...
		[CompilerGenerated]
		private static int _003CAttachDevice_003Em__0(InputDevice d1, InputDevice d2)
		{
