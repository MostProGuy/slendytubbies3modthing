...
namespace CodeStage.AntiCheat.Detectors
{
	...
	public abstract class ACTkDetectorBase : MonoBehaviour
	{
		...
		protected virtual void OnDestroy()
		{
			...
			else if (base.name == "Anti-Cheat Toolkit Detectors" && GetComponentsInChildren<ACTkDetectorBase>().Length <= 1)
			{
				UnityEngine.Object.Destroy(base.gameObject);
			}
		}
		...
		protected virtual bool Init(ACTkDetectorBase instance, string detectorName)
		{
			...
			UnityEngine.Object.DontDestroyOnLoad((!(base.transform.parent != null)) ? base.gameObject : base.transform.root.gameObject);
			return true;
		}
