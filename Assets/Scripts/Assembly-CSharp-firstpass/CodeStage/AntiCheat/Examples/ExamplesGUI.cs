...
namespace CodeStage.AntiCheat.Examples
{
	...
	public class ExamplesGUI : MonoBehaviour
	{
		...
		private bool wrongTimeDetected;
		...
		private void OnGUI()
		{
			...
			else
			{
				...
				using (new VerticalLayout(GUI.skin.box))
				{
					GUILayout.Label("<b>SpeedHackDetector</b>");
					...
					{
						GUILayout.Label("<b>TimeCheatingDetector</b> (updates once per 1 min by default)");
					...
					GUILayout.Space(10f);
					GUILayout.Label("<b>ObscuredCheatingDetector</b>");
					...
					GUILayout.Space(10f);
					GUILayout.Label("<b>WallHackDetector</b>");
					...
					GUILayout.Space(10f);
					GUILayout.Label("<b>InjectionDetector</b>");
