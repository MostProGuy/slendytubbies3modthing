...
public class PhotonAnimatorView : MonoBehaviour, IPunObservable
{
	...
	[CompilerGenerated]
	private sealed class _003CDoesLayerSynchronizeTypeExist_003Ec__AnonStorey0
	{
		internal int layerIndex;

		internal bool _003C_003Em__0(SynchronizedLayer item)
		{
	...
	[CompilerGenerated]
	private sealed class _003CDoesParameterSynchronizeTypeExist_003Ec__AnonStorey1
	{
		internal string name;

		internal bool _003C_003Em__0(SynchronizedParameter item)
		{
	...
	[CompilerGenerated]
	private sealed class _003CGetLayerSynchronizeType_003Ec__AnonStorey2
	{
		internal int layerIndex;
	...
	[CompilerGenerated]
	private sealed class _003CGetParameterSynchronizeType_003Ec__AnonStorey3
	{
		internal string name;
	...
	[CompilerGenerated]
	private sealed class _003CSetLayerSynchronized_003Ec__AnonStorey4
	{
		internal int layerIndex;
	...
	[CompilerGenerated]
	private sealed class _003CSetParameterSynchronized_003Ec__AnonStorey5
	{
		internal string name;
	...
	{
		_003CDoesLayerSynchronizeTypeExist_003Ec__AnonStorey0 _003CDoesLayerSynchronizeTypeExist_003Ec__AnonStorey = new _003CDoesLayerSynchronizeTypeExist_003Ec__AnonStorey0();
		_003CDoesLayerSynchronizeTypeExist_003Ec__AnonStorey.layerIndex = layerIndex;
		return m_SynchronizeLayers.FindIndex(_003CDoesLayerSynchronizeTypeExist_003Ec__AnonStorey._003C_003Em__0) != -1;
	}

	public bool DoesParameterSynchronizeTypeExist(string name)
	{
		_003CDoesParameterSynchronizeTypeExist_003Ec__AnonStorey1 _003CDoesParameterSynchronizeTypeExist_003Ec__AnonStorey = new _003CDoesParameterSynchronizeTypeExist_003Ec__AnonStorey1();
		_003CDoesParameterSynchronizeTypeExist_003Ec__AnonStorey.name = name;
		return m_SynchronizeParameters.FindIndex(_003CDoesParameterSynchronizeTypeExist_003Ec__AnonStorey._003C_003Em__0) != -1;
	}
	...
	{
		_003CGetLayerSynchronizeType_003Ec__AnonStorey2 _003CGetLayerSynchronizeType_003Ec__AnonStorey = new _003CGetLayerSynchronizeType_003Ec__AnonStorey2();
		_003CGetLayerSynchronizeType_003Ec__AnonStorey.layerIndex = layerIndex;
		int num = m_SynchronizeLayers.FindIndex(_003CGetLayerSynchronizeType_003Ec__AnonStorey._003C_003Em__0);
		if (num == -1)
		{
	...
	{
		_003CGetParameterSynchronizeType_003Ec__AnonStorey3 _003CGetParameterSynchronizeType_003Ec__AnonStorey = new _003CGetParameterSynchronizeType_003Ec__AnonStorey3();
		_003CGetParameterSynchronizeType_003Ec__AnonStorey.name = name;
		int num = m_SynchronizeParameters.FindIndex(_003CGetParameterSynchronizeType_003Ec__AnonStorey._003C_003Em__0);
		if (num == -1)
		{
			return SynchronizeType.Disabled;
		}
	...
	{
		_003CSetLayerSynchronized_003Ec__AnonStorey4 _003CSetLayerSynchronized_003Ec__AnonStorey = new _003CSetLayerSynchronized_003Ec__AnonStorey4();
		_003CSetLayerSynchronized_003Ec__AnonStorey.layerIndex = layerIndex;
		if (Application.isPlaying)
		{
			m_WasSynchronizeTypeChanged = true;
		}
		int num = m_SynchronizeLayers.FindIndex(_003CSetLayerSynchronized_003Ec__AnonStorey._003C_003Em__0);
		if (num == -1)
		{
			m_SynchronizeLayers.Add(new SynchronizedLayer
			{
				LayerIndex = _003CSetLayerSynchronized_003Ec__AnonStorey.layerIndex,
	...
	{
		_003CSetParameterSynchronized_003Ec__AnonStorey5 _003CSetParameterSynchronized_003Ec__AnonStorey = new _003CSetParameterSynchronized_003Ec__AnonStorey5();
		_003CSetParameterSynchronized_003Ec__AnonStorey.name = name;
		if (Application.isPlaying)
		{
			m_WasSynchronizeTypeChanged = true;
		}
		int num = m_SynchronizeParameters.FindIndex(_003CSetParameterSynchronized_003Ec__AnonStorey._003C_003Em__0);
		if (num == -1)
		{
			m_SynchronizeParameters.Add(new SynchronizedParameter
			{
				Name = _003CSetParameterSynchronized_003Ec__AnonStorey.name,
				Type = type,
				SynchronizeType = synchronizeType
			});
		}
