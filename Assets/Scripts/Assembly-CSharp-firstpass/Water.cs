...
public class Water : MonoBehaviour
{
	...
	private void OnDisable()
	{
		...
		IDictionaryEnumerator enumerator2 = m_RefractionCameras.GetEnumerator();
		try
		{
			while (enumerator2.MoveNext())
			{
				UnityEngine.Object.DestroyImmediate(((Camera)((DictionaryEntry)enumerator2.Current).Value).gameObject);
			}
		}
		finally
		{
