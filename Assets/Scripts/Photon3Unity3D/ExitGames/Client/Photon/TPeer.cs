...
namespace ExitGames.Client.Photon
{
	internal class TPeer : PeerBase
	{
		...
		internal void SendData(byte[] data)
		{
			...
			_003C_003Ec__DisplayClass30_.data = data;
			try
			{
				bytesOut += _003C_003Ec__DisplayClass30_.data.Length;
				if (base.TrafficStatsEnabled)
				{
					base.TrafficStatsOutgoing.TotalPacketCount++;
				...
				{
					SendNetworkSimulated(_003C_003Ec__DisplayClass30_._003CSendData_003Eb__0);
				}
				else
				{
					rt.Send(_003C_003Ec__DisplayClass30_.data, _003C_003Ec__DisplayClass30_.data.Length);
				}
			}
			catch (Exception ex)
			{
