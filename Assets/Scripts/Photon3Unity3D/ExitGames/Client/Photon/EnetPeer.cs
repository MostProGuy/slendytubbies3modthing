...
namespace ExitGames.Client.Photon
{
	internal class EnetPeer : PeerBase
	{
		...
		private sealed class _003C_003Ec__DisplayClass56_0
		{
			...
			public _003C_003Ec__DisplayClass56_1 CS_0024_003C_003E8__locals1;

			internal void _003CSendToSocket_003Eb__0()
			{
		...
		private void SendToSocket(byte[] data, int length)
		{
			...
			_003C_003Ec__DisplayClass56_.length = length;
			if (base.NetworkSimulationSettings.IsSimulationEnabled)
			{
				_003C_003Ec__DisplayClass56_0 _003C_003Ec__DisplayClass56_2 = new _003C_003Ec__DisplayClass56_0();
				_003C_003Ec__DisplayClass56_2.CS_0024_003C_003E8__locals1 = _003C_003Ec__DisplayClass56_;
				_003C_003Ec__DisplayClass56_2.dataCopy = new byte[_003C_003Ec__DisplayClass56_2.CS_0024_003C_003E8__locals1.length];
				Buffer.BlockCopy(data, 0, _003C_003Ec__DisplayClass56_2.dataCopy, 0, _003C_003Ec__DisplayClass56_2.CS_0024_003C_003E8__locals1.length);
				SendNetworkSimulated(_003C_003Ec__DisplayClass56_2._003CSendToSocket_003Eb__0);
			}
			else
			{
				rt.Send(data, _003C_003Ec__DisplayClass56_.length);
			}
		}
		...
		internal override void ReceiveIncomingCommands(byte[] inBuff, int dataLength)
		{
			...
			try
			{
				...
				for (int i = 0; i < b2; i++)
				{
					...
					_003C_003Ec__DisplayClass62_._003C_003E4__this = this;
					_003C_003Ec__DisplayClass62_.readCommand = new NCommand(this, inBuff, ref offset);
					if (_003C_003Ec__DisplayClass62_.readCommand.commandType != 1)
					{
						EnqueueActionForDispatch(_003C_003Ec__DisplayClass62_._003CReceiveIncomingCommands_003Eb__0);
					}
					else
					{
						ExecuteCommand(_003C_003Ec__DisplayClass62_.readCommand);
					}
					if ((_003C_003Ec__DisplayClass62_.readCommand.commandFlags & 1) > 0)
					{
						if (InReliableLog != null)
						{
							InReliableLog.Enqueue(new CmdLogReceivedReliable(_003C_003Ec__DisplayClass62_.readCommand, timeInt, roundTripTime, roundTripTimeVariance, timeInt - timeLastSendOutgoing, timeInt - timeLastSendAck));
							CommandLogResize();
						}
						QueueOutgoingAcknowledgement(_003C_003Ec__DisplayClass62_.readCommand, serverSentTime);
						if (base.TrafficStatsEnabled)
						{
		...
		internal bool ExecuteCommand(NCommand command)
		{
			...
			case 1:
			{
				...
				if (nCommand.commandType == 4 && peerConnectionState == ConnectionStateValue.Disconnecting)
				{
					...
					EnqueueActionForDispatch(_003CExecuteCommand_003Eb__63_0);
				}
		...
		[CompilerGenerated]
		private void _003CExecuteCommand_003Eb__63_0()
		{
			rt.Disconnect();
		}
	}
