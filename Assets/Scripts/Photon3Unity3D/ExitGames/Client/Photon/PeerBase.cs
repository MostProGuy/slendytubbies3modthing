...
namespace ExitGames.Client.Photon
{
	public abstract class PeerBase
	{
		...
		internal byte[] SerializeMessageToMessage(object message, bool encrypt, byte[] messageHeader, bool writeLength = true)
		{
			...
			if (encrypt)
			{
				array3[messageHeader.Length - 1] = (byte)(array3[messageHeader.Length - 1] | 0x80u);
			}
			if (writeLength)
			{
				int targetOffset = 1;
		...
		internal void EnqueueDebugReturn(DebugLevel level, string debugReturn)
		{
			...
			_003C_003Ec__DisplayClass145_._003C_003E4__this = this;
			_003C_003Ec__DisplayClass145_.level = level;
			_003C_003Ec__DisplayClass145_.debugReturn = debugReturn;
			lock (ActionQueue)
			{
				ActionQueue.Enqueue(_003C_003Ec__DisplayClass145_._003CEnqueueDebugReturn_003Eb__0);
			}
		}

		internal void EnqueueStatusCallback(StatusCode statusValue)
		{
			_003C_003Ec__DisplayClass146_0 _003C_003Ec__DisplayClass146_ = new _003C_003Ec__DisplayClass146_0();
			_003C_003Ec__DisplayClass146_._003C_003E4__this = this;
			_003C_003Ec__DisplayClass146_.statusValue = statusValue;
			lock (ActionQueue)
			{
				ActionQueue.Enqueue(_003C_003Ec__DisplayClass146_._003CEnqueueStatusCallback_003Eb__0);
			}
		}
